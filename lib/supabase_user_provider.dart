...
class Dashborad02SupabaseUser extends BaseAuthUser {
  Dashborad02SupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> dashborad02SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = Dashborad02SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
